object Lab3 {
  ...
  val a = ArrayBuffer(3, 6, 7, 3,-4, 8, -3, -5, 6, 7, -2, 9, -1)
                                                  //> a  : scala.collection.mutable.ArrayBuffer[Int] = ArrayBuffer(3, 6, 7, 3, -4,
                                                  //|  8, -3, -5, 6, 7, -2, 9, -1)
  ...
  def rmNeg1(a: ArrayBuffer[Int]): ArrayBuffer[Int] = {
   	...
   	a
  }                                               //> rmNeg1: (a: scala.collection.mutable.ArrayBuffer[Int])scala.collection.mutab
                                                  //| le.ArrayBuffer[Int]
  ...
  def rmNeg2(a: ArrayBuffer[Int]): ArrayBuffer[Int] = {
  	...
  	var firstNeg = false
   	...
   	a
  }                                               //> rmNeg2: (a: scala.collection.mutable.ArrayBuffer[Int])scala.collection.mutab
                                                  //| le.ArrayBuffer[Int]
   
   rmNeg1(a)                                      //> res1: scala.collection.mutable.ArrayBuffer[Int] = ArrayBuffer(3, 6, 7, 3, -4
                                                  //| , 8, 6, 7, 9)
   //rmNeg2(a)
